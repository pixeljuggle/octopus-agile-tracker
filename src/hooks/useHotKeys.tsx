...
const getHotkeyMatcher = (hotkey: string): CheckHotkeyMatch => {
...
const getHotkeyHandler = (hotkeys: HotkeyItem[]) => {
...
export const useHotkeys = (hotkeys: HotkeyItem[], tagsToIgnore: string[] = ['INPUT', 'TEXTAREA', 'SELECT'], triggerOnContentEditable = false) => {
  useEffect(() => {
